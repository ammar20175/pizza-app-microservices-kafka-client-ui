    ...
    <div className="flex container gap-6 mt-16">
                  ...
                  <Card className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="option-one" className="leading-normal">
                        New Emrites Tower office 20213 Dubai Uae next to Museam
                        of future
                      </Label>
                    </div>
                  </Card>
                  <Card className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="option-two" className="leading-normal">
                        Mirdiff city center Dubai shop 3041 next to Apple store
                      </Label>
                    </div>
                  </Card>
                </RadioGroup>
      ...
      <Card className="w-2/5 border-none h-auto self-start">
        ...
        <CardContent className="grid gap-4 pt-6">
          <div className="flex items-center justify-between">
            <span>Subtotal</span>
            <span className="font-bold">Rs 8130</span>
          </div>
          <div className="flex items-center justify-between">
            <span>Taxes</span>
            <span className="font-bold">Rs 82</span>
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-bold">Rs 8300</span>
          </div>
